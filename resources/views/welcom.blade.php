    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center justify-center space-x-2 m-4 pt-8 sm:justify-start sm:pt-0">
                  <img class="rounded-full h-16 w-16" src="img/icono.png" alt="">
                  <p class="text-white text-6xl">LUCEM</p>
                  <div class="container bottom-2 w-96 mt-2 pl-6">
                    <form class="relative flex space-x-2 pb-1" action="{{route('advert.search')}}" method="GET">
                        @csrf
                        <input name="word" class="w-full h-11 rounded  focus:outline-none  pb-3 focus:shadow-outline text-xl px-8 shadow-lg" type="search" placeholder="Buscar por nombre...">
                        <button type="submit"><i class="text-yellow-500 fa fa-search text-xl    "></i>
                        </button>
                  ...
                  <div class="hidden  top-0 right-0 px-6 py-4 sm:block">
                      @auth
                          <a href="{{ url('/adverts/show/f?') }}" class="text-sm text-white underline">Buscar</a>
                      @else
                          <a href="{{ route('login') }}" class="text-sm text-white underline">Iniciar Sesión</a>
  
                          @if (Route::has('register'))
                              <a href="{{ route('register') }}" class="ml-4 text-sm text-white underline">Registrate</a>
                          @endif
                      @endauth
                  </div>
              @endif  
                ...
                <div style="background-color: orange;">
                    <b>
                        <div class="container row" style="padding-left: 100px;">
                    ...
                    <div>
                        <img src="img/Landing.jpg" width="100%">
                    </div>
                    <div style="margin: auto;width: 25%; text-align: center;">
                        <p style="margin-top: 10px; color: white;"> <b>¡Entérate de nuestras novedades!</b> </p>
                        <button class="btn btn-danger" style="margin-bottom: 10px;"> <b>¡Comienza aqui!</b></button>
                    </div>
                </div>
